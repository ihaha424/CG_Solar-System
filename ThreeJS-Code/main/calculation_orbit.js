...
export class OrbitControls extends THREE.EventDispatcher{
    constructor(object, domElement, Window ) {
        super();
        this.object = object;
        ...
        this.position0 = this.object.position0.clone();
        ...
        this.onMouseDown = (event)=> {
            ...
            if(event.button === this.mouseButton.ORBIT){
                if(this.enableRotation === false) return;
                this.rotateStart.set(event.clientX,event.clientY);
                this.state = STATE.ROTATE;
            }else if(event.button === this.mouseButton.ZOOM){
                if(this.enableZoom === false) return;
                this.dollyStart.set(event.clientX,event.clientY);
                this.state = STATE.DOLLY;
            }else if(event.button === this.mouseButton.PAN){
